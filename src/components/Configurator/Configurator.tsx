...
export default function Configurator({
    ...
    function addRelation() {
        ...
        newDragon.relations = dragon.relations;
        let relation: string;
    ...
    const accessories = () => {
        ...
        if (info == null) return (
            <Text>It seems like you have an invalid style pack applied. Select one of the provided style packs.</Text>);
                ...
                <Group align='flex-end'>
                    <Group grow flex={1}>
                        ...
                        <Autocomplete
                            ...
                            data={locations}
                            onChange={(value) => {
                                setLocation(location.identifier, value);
                            }}
                            rightSection={
                                <ActionIcon
            ...
            for (let i = 0; i < dragon.relations.length; i++) {
                ...
                if (relation.name == 'Unknown')
                    relationElements.push(
                        <li key={`relation${i}`}>{relation.name} {haveTense} a {relation.relation.toLowerCase()} whose
                            name is not known.</li>
                    );
                ...
                >
                    <Stack>
                        <Stack>
                            ...
                            <Text>Check the <Anchor href='https://wingsoffire.fandom.com/wiki/Map:Pyrrhia' target='new'>Pyrrhia
                                map<FontAwesomeIcon icon={faArrowUpRightFromSquare} size='xs'/></Anchor> or <Anchor
                                href='https://wingsoffire.fandom.com/wiki/Map:Pantala' target='new'>Pantala
                                map<FontAwesomeIcon icon={faArrowUpRightFromSquare} size='xs'/></Anchor> for
                                help.</Text>
                        </Stack>
                        <SimpleGrid cols={{base: 1, md: 2}}>
                            <Autocomplete
                                ...
                                data={locations}
                                onChange={(value) => {
                                    setLocation('Hatching location', value);
                                }}
                                rightSection={
                                    <ActionIcon
                                        aria-label="Randomize"
                            ...
                            <Autocomplete
                                ...
                                data={locations}
                                onChange={(value) => {
                                    setLocation('Growing up location', value);
                                }}
                                rightSection={
                                    <ActionIcon
                                        aria-label="Randomize"
                            ...
                            <Autocomplete
                                ...
                                data={locations}
                                onChange={(value) => {
                                    setLocation('Home location', value);
                                }}
                                rightSection={
                                    <ActionIcon
                                        aria-label="Randomize"
                            ...
                            <Autocomplete
                                ...
                                data={locations}
                                onChange={(value) => {
                                    setLocation('Current location', value);
                                }}
                                rightSection={
                                    <ActionIcon
                                        aria-label="Randomize"
